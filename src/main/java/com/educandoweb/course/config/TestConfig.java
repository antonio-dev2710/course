...
import com.educandoweb.course.repositeries.OrderItemRepository;
...
//so vai rodar essa confugração quando tiver no perfil de teste
//principios solid : quando um serviso depende de outro essa dependencia tem que ser
//desaclopada 
//associar uma intancia do userRepository no teste config @Autowired
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// adicionar as categorias nos produtos
		...
		// salvar os produtos com as novas associaçoes
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		//assoicação de mao dupla em memoria
		o1.setPayment(pay1);
